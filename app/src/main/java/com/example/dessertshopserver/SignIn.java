                ...
                if(dataSnapshot.child(localPhone).exists()){
                    ...
                    if(Boolean.parseBoolean(user.getIsStaff())) { //if isStaff == true
                        if(user.getPassword().equals(localPassword)){
                            ...
                            Toast.makeText(SignIn.this, "Password yang Anda Masukan Salah", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        Toast.makeText(SignIn.this, "Login Menggunakan Akun Admin", Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    mDialog.dismiss();
